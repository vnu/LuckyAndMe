...
class ViewController: UIViewController {
    ...
    var firstContainer: UIView! // Unwrapping (check about it)
    ...
    // Information Labels third Container
    ...
    // Constants for margins and View height and widths
    let kMarginForView:CGFloat = 10.0 //CG Float can change to float or double based on system and view accepts CGFloat
...
//        setUpSecondContainer(self.secondContainer) // Being set in hard reset!
    ...
    // If they have less than 5 credits, ask them to bet less
    // > 5 bet remaining amount if they had already bet to match 5 or match 5
    ...
    func validateCurrentBet() -> Bool{
        return currentBet > 0
    }

    func spinButtonPressed(button: UIButton){
        if validateCurrentBet(){
            removeSlotImageViews() // To avoid creating views on top of one another everytime Spin is pressed
            ...
            showAlertWithText(header: "Place Bet", message: "Please Bet to Spin")
        }
    ...
    // Abstract and modularize code that would come in ViewDidLoad()
    ...
    func setUpThirdContainer(containterView: UIView){
        self.creditsLabel = UILabel()
        self.creditsLabel.text = "000000"
        self.creditsLabel.textColor = UIColor.redColor()
        self.creditsLabel.font = UIFont(name: "Menlo-Bold", size: 16)
        self.creditsLabel.sizeToFit()
        self.creditsLabel.center = CGPoint(x: containterView.frame.width * kSixth, y: containterView.frame.height * kThird)
        self.creditsLabel.textAlignment = NSTextAlignment.Center
        self.creditsLabel.backgroundColor = UIColor.whiteColor()
        containterView.addSubview(self.creditsLabel)
        ...
        self.betLabel.center = CGPoint(x: containterView.frame.width * kSixth * 3 , y: containterView.frame.height * kThird)
        self.betLabel.textAlignment = NSTextAlignment.Center
        self.betLabel.backgroundColor = UIColor.whiteColor()
        containterView.addSubview(self.betLabel)
        ...
        self.winnerPaidLabel.center = CGPoint(x: containterView.frame.width * kSixth * 5 , y: containterView.frame.height * kThird)
        self.winnerPaidLabel.textAlignment = NSTextAlignment.Center
        self.winnerPaidLabel.backgroundColor = UIColor.whiteColor()
        containterView.addSubview(self.winnerPaidLabel)
        ...
        self.creditsTitleLabel.center = CGPoint(x: containterView.frame.width * kSixth, y: containterView.frame.height * kThird * 2)
        containterView.addSubview(self.creditsTitleLabel)
        ...
        self.betTitleLabel.center = CGPoint(x: containterView.frame.width * kSixth * 3, y: containterView.frame.height * kThird * 2)
        containterView.addSubview(self.betTitleLabel)
        ...
        self.winnerPaidTitleLabel.center = CGPoint(x: containterView.frame.width * kSixth * 5, y: containterView.frame.height * kThird * 2)
        containterView.addSubview(self.winnerPaidTitleLabel)
